...
class FilterScreen extends StatefulWidget {
  ...
  const FilterScreen({super.key, required this.searchFlag});
...
class _FilterScreenState extends State<FilterScreen> {
          ...
          onPressed: () {
            productBloc.add(
              UpdateProductFilters(
                ...
                searchText:
                    (widget.searchFlag)
                        ? getIt<SearchBloc>().recentWords.last
                        : "",
              ),
            );
  ...
  ExpansionTile buildPriceRangeTile() {
  ...
  ExpansionTile buildCategoryTile() {
    return ExpansionTile(
      shape: Border(),
      trailing:
